...
if __name__ == '__main__':
    ...
    area_4_a = np.zeros_like(luminosity)
    ...
    for j, lum in enumerate(luminosity):
        ...
        if area_4 < 0.01:
            area_4 = 0.01
        area_barren = 1 - (area_black + area_white + area_3 + area_4)

        albedo_planet = (area_black * albedo_black + 
                         area_white * albedo_white + 
                         area_3 * albedo_3 + 
                         area_4 * albedo_4 + 
                         area_barren * albedo_barren)
        ...
        temp_4 = (insul*lum*S/sigma*(albedo_planet-albedo_4) + temp_planet**4)**(0.25)
        ...
        if (temp_3 >= temp_min and temp_3 <= temp_max):
            ...
            birth_3 = 0
        if (temp_4 >= temp_min and temp_4 <= temp_max):
            birth_4 = 1 - 0.003265*(temp_opt-temp_4)**2
        else:
            birth_4 = 0
        ...
        area_4 += area_4*(birth_4*area_barren-death_rate)
